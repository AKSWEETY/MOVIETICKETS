...
namespace KadariTicketSales.Models
{
    public class EventService
    {
        ...
        {
            new Events(){Id=100, Title="The Lion King", CategoryId=1, TicketPrice = 50, Description="Muscial Based on Disney's animated movie", ImageId="100.jpeg"},
            new Events(){Id=200, Title="Holiday Spectacular", CategoryId=2 , TicketPrice = 40, Description="Holiday extravaganza for the entire family", ImageId="200.jpeg"},
            new Events(){Id=300, Title="Mary Poppins", CategoryId=1, TicketPrice = 50, Description="The popular musical with seven tony awards.", ImageId="300.jpeg"},
            new Events(){Id=400, Title="Taylor Swift", CategoryId=2, TicketPrice = 90, Description="Popular singer and songwriter", ImageId="400.jpeg"},
            new Events(){Id=500, Title="Alice in Wonderland",CategoryId=1, TicketPrice=90,Description="Alice in Wonderland and through the looking-glass by lewis carroll",ImageId="500.jpeg"}
